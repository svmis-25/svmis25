...
if($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['id'])){
	$id = intval($_POST['id']);
		...
		$sql = "UPDATE drivers SET is_active = 0, `status` = 'unavailable' WHERE id = ?";
        ...
        $activity_id = 15; // represents the activity ID for deactivating a driver
        saveActivityLog($current_user_role_id, $activity_id, $current_user_id);
				...
				echo "Data deletion failed: $stmt->error";
			}
