...
$requiredFields = ['driver_id', 'firstname', 'lastname', 'email', 'contact', 'address', 'age'];
...
$sql = "UPDATE drivers_contact_person SET firstname = ?, middlename = ?, lastname = ?, qualifier = ?, email = ?, contact = ?, address = ?, age = ? WHERE driver_id = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("sssssssii", $firstname, $middlename, $lastname, $qualifier, $email, $contact, $address, $age, $driver_id);
